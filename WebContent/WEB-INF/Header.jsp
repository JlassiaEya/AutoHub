...
<header>
    <div class="nav container">
        ...
        <ul class="navbar">
            ...
            <li><a href="Article">Ajouter un Article</a></li>
            <li><a href="ListeCServlets">Liste des Commandes</a></li>
           <li><a href="UserArticle">Votre Articles</a></li>
        </ul>
...
<a href="Profile">
<img src="/Projet_Gestion_Ferailles/images/userr.png" class="img">
</a>
    </div>
</header>
